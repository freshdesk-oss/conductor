...
/** Stub listener for journey implementation */
public class JourneyTaskStatusListenerStub implements TaskStatusListener {

    private static final Logger LOGGER = LoggerFactory.getLogger(JourneyTaskStatusListenerStub.class);
    private final EventPublisher eventPublisher;

    public JourneyTaskStatusListenerStub(EventPublisher eventPublisher) {
