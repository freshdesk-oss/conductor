...
public class JourneyWorkflowStatusListenerStub implements WorkflowStatusListener {

    private static final Logger LOGGER = LoggerFactory.getLogger(WorkflowStatusListenerStub.class);
    private final EventPublisher eventPublisher;

    public JourneyWorkflowStatusListenerStub(EventPublisher eventPublisher) {
